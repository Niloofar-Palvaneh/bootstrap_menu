        ...
        <>
            <div className='text-gray-200'>
                <div className='bg-[#712cf9] flex items-center justify-around py-2 dark:bg-gray-600 transition-all'>
                    ...
                    <div className='sm:hidden flex gap-2 items-center justify-start rounded-md px-2 py-1 opacity-80 hover:opacity-100 hover:shadow-[0px_0px_2px_2px_#ffe484] transition-all border border-gray-200'>
                    ...
                    <div className='flex items-center gap-12 sm:hidden'>
                        ...
                        <div className='relative'>
                            ...
                            <ul className={`${showDarkOrLightModeMenu ? "flex" : "hidden"} absolute flex-col bg-white text-gray-900 dark:bg-gray-400 rounded gap-2 overflow-hidden border shadow`}>
                                <li className='hover:bg-gray-100 w-full text-center transition-all cursor-pointer px-4 py-1 ' onClick={toggleTheme}>Dark</li>
                                <li className='hover:bg-gray-100 w-full text-center transition-all cursor-pointer px-4 py-1 ' onClick={toggleTheme}>Light</li>
                                <li className='hover:bg-gray-100 w-full text-center transition-all cursor-pointer px-4 py-1 ' onClick={toggleTheme}>Auto</li>
                            </ul>
                        </div>
                    </div>
            ...
            <Modal closeIcon={<Close/>} style={{ top: 10 , left:0}} title="Bootstrap" open={isModalOpenMobileMenu} onCancel={toggleShowMobileMenu} footer={false}>
