  ...
  return (
    <>
      <div className='text-gray-200'>
        <div className='bg-[#712cf9] flex items-center justify-around py-2 dark:bg-gray-600 transition-all sm:bg-red-500'>
          ...
          <div className='flex gap-2 items-center justify-start rounded-md px-2 py-1 opacity-80 hover:opacity-100 hover:shadow-[0px_0px_2px_2px_#ffe484] transition-all border border-gray-200'>
